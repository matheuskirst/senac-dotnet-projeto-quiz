...
namespace SenacQuizApp.Migrations
{
    ...
    [Migration("20260909021954_AtualizaQuestoes")]
    partial class AtualizaQuestoes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SenacQuizApp.Modelos.Usuarios.UsuarioConquista", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DataDesbloqueio")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamptz")
                        .HasDefaultValueSql("CURRENT_TIMESTAMP");
